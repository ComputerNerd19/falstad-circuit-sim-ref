...
public class CirSim extends JFrame implements ComponentListener, ActionListener, AdjustmentListener, MouseMotionListener, MouseListener, ItemListener, KeyListener
{
    ...
    public void init()
    {
        ...
        passMenu.add(getClassCheckItem("Add Tapped Transformer", "de.mobillinux.jcircsim.TappedTransformerElm"));
        passMenu.add(getClassCheckItem("Add Transmission Line", "de.mobillinux.jcircsim.TransLineElm"));
        ...
        inputMenu.add(getClassCheckItem("Add Voltage Source (2-terminal)", "de.mobillinux.jcircsim.DCVoltageElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (2-terminal)", "de.mobillinux.jcircsim.ACVoltageElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (1-terminal)", "de.mobillinux.jcircsim.RailElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (1-terminal)", "de.mobillinux.jcircsim.ACRailElm"));
        inputMenu.add(getClassCheckItem("Add Square Wave (1-terminal)", "de.mobillinux.jcircsim.SquareRailElm"));
        ...
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, NPN)", "de.mobillinux.jcircsim.NTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, PNP)", "de.mobillinux.jcircsim.PTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (- on top)", "de.mobillinux.jcircsim.OpAmpElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (+ on top)", "de.mobillinux.jcircsim.OpAmpSwapElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (n-channel)", "de.mobillinux.jcircsim.NMosfetElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (p-channel)", "de.mobillinux.jcircsim.PMosfetElm"));
        ...
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPST)", "de.mobillinux.jcircsim.AnalogSwitchElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPDT)", "de.mobillinux.jcircsim.AnalogSwitch2Elm"));
