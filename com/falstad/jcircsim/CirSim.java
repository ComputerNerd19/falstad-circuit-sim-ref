...
public class CirSim extends JFrame implements ComponentListener, ActionListener, AdjustmentListener, MouseMotionListener, MouseListener, ItemListener, KeyListener
{
    ...
    public void init()
    {
        ...
        mainMenu.add(getClassCheckItem("Add Wire", "com.falstad.jcircsim.WireElm"));
        mainMenu.add(getClassCheckItem("Add Resistor", "com.falstad.jcircsim.ResistorElm"));

        Menu passMenu = new Menu("Passive Components");
        mainMenu.add(passMenu);
        passMenu.add(getClassCheckItem("Add Capacitor", "com.falstad.jcircsim.CapacitorElm"));
        passMenu.add(getClassCheckItem("Add Inductor", "com.falstad.jcircsim.InductorElm"));
        passMenu.add(getClassCheckItem("Add Switch", "com.falstad.jcircsim.SwitchElm"));
        passMenu.add(getClassCheckItem("Add Push Switch", "com.falstad.jcircsim.PushSwitchElm"));
        passMenu.add(getClassCheckItem("Add SPDT Switch", "com.falstad.jcircsim.Switch2Elm"));
        passMenu.add(getClassCheckItem("Add Potentiometer", "com.falstad.jcircsim.PotElm"));
        passMenu.add(getClassCheckItem("Add Transformer", "com.falstad.jcircsim.TransformerElm"));
        passMenu.add(getClassCheckItem("Add Tapped Transformer", "com.falstad.jcircsim.TappedTransformerElm"));
        passMenu.add(getClassCheckItem("Add Transmission Line", "com.falstad.jcircsim.TransLineElm"));
        passMenu.add(getClassCheckItem("Add Relay", "com.falstad.jcircsim.RelayElm"));
        passMenu.add(getClassCheckItem("Add Memristor", "com.falstad.jcircsim.MemristorElm"));
        passMenu.add(getClassCheckItem("Add Spark Gap", "com.falstad.jcircsim.SparkGapElm"));

        Menu inputMenu = new Menu("Inputs/Outputs");
        mainMenu.add(inputMenu);
        inputMenu.add(getClassCheckItem("Add Ground", "com.falstad.jcircsim.GroundElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (2-terminal)", "com.falstad.jcircsim.DCVoltageElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (2-terminal)", "com.falstad.jcircsim.ACVoltageElm"));
        inputMenu.add(getClassCheckItem("Add Voltage Source (1-terminal)", "com.falstad.jcircsim.RailElm"));
        inputMenu.add(getClassCheckItem("Add A/C Source (1-terminal)", "com.falstad.jcircsim.ACRailElm"));
        inputMenu.add(getClassCheckItem("Add Square Wave (1-terminal)", "com.falstad.jcircsim.SquareRailElm"));
        inputMenu.add(getClassCheckItem("Add Analog Output", "com.falstad.jcircsim.OutputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Input", "com.falstad.jcircsim.LogicInputElm"));
        inputMenu.add(getClassCheckItem("Add Logic Output", "com.falstad.jcircsim.LogicOutputElm"));
        inputMenu.add(getClassCheckItem("Add Clock", "com.falstad.jcircsim.ClockElm"));
        inputMenu.add(getClassCheckItem("Add A/C Sweep", "com.falstad.jcircsim.SweepElm"));
        inputMenu.add(getClassCheckItem("Add Var. Voltage", "com.falstad.jcircsim.VarRailElm"));
        inputMenu.add(getClassCheckItem("Add Antenna", "com.falstad.jcircsim.AntennaElm"));
        inputMenu.add(getClassCheckItem("Add Current Source", "com.falstad.jcircsim.CurrentElm"));
        inputMenu.add(getClassCheckItem("Add LED", "com.falstad.jcircsim.LEDElm"));
        inputMenu.add(getClassCheckItem("Add Lamp (beta)", "com.falstad.jcircsim.LampElm"));

        Menu activeMenu = new Menu("Active Components");
        mainMenu.add(activeMenu);
        activeMenu.add(getClassCheckItem("Add Diode", "com.falstad.jcircsim.DiodeElm"));
        activeMenu.add(getClassCheckItem("Add Zener Diode", "com.falstad.jcircsim.ZenerElm"));
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, NPN)", "com.falstad.jcircsim.NTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Transistor (bipolar, PNP)", "com.falstad.jcircsim.PTransistorElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (- on top)", "com.falstad.jcircsim.OpAmpElm"));
        activeMenu.add(getClassCheckItem("Add Op Amp (+ on top)", "com.falstad.jcircsim.OpAmpSwapElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (n-channel)", "com.falstad.jcircsim.NMosfetElm"));
        activeMenu.add(getClassCheckItem("Add MOSFET (p-channel)", "com.falstad.jcircsim.PMosfetElm"));
        activeMenu.add(getClassCheckItem("Add JFET (n-channel)", "com.falstad.jcircsim.NJfetElm"));
        activeMenu.add(getClassCheckItem("Add JFET (p-channel)", "com.falstad.jcircsim.PJfetElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPST)", "com.falstad.jcircsim.AnalogSwitchElm"));
        activeMenu.add(getClassCheckItem("Add Analog Switch (SPDT)", "com.falstad.jcircsim.AnalogSwitch2Elm"));
        activeMenu.add(getClassCheckItem("Add SCR", "com.falstad.jcircsim.SCRElm"));
        // activeMenu.add(getClassCheckItem("Add Varactor/Varicap",
        // "VaractorElm"));
        activeMenu.add(getClassCheckItem("Add Tunnel Diode", "com.falstad.jcircsim.TunnelDiodeElm"));
        activeMenu.add(getClassCheckItem("Add Triode", "com.falstad.jcircsim.TriodeElm"));
        ...
        activeMenu.add(getClassCheckItem("Add CCII+", "com.falstad.jcircsim.CC2Elm"));
        activeMenu.add(getClassCheckItem("Add CCII-", "com.falstad.jcircsim.CC2NegElm"));

        Menu gateMenu = new Menu("Logic Gates");
        mainMenu.add(gateMenu);
        gateMenu.add(getClassCheckItem("Add Inverter", "com.falstad.jcircsim.InverterElm"));
        gateMenu.add(getClassCheckItem("Add NAND Gate", "com.falstad.jcircsim.NandGateElm"));
        gateMenu.add(getClassCheckItem("Add NOR Gate", "com.falstad.jcircsim.NorGateElm"));
        gateMenu.add(getClassCheckItem("Add AND Gate", "com.falstad.jcircsim.AndGateElm"));
        gateMenu.add(getClassCheckItem("Add OR Gate", "com.falstad.jcircsim.OrGateElm"));
        gateMenu.add(getClassCheckItem("Add XOR Gate", "com.falstad.jcircsim.XorGateElm"));

        Menu chipMenu = new Menu("Chips");
        mainMenu.add(chipMenu);
        chipMenu.add(getClassCheckItem("Add D Flip-Flop", "com.falstad.jcircsim.DFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add JK Flip-Flop", "com.falstad.jcircsim.JKFlipFlopElm"));
        chipMenu.add(getClassCheckItem("Add 7 Segment LED", "com.falstad.jcircsim.SevenSegElm"));
        chipMenu.add(getClassCheckItem("Add VCO", "com.falstad.jcircsim.VCOElm"));
        chipMenu.add(getClassCheckItem("Add Phase Comparator", "com.falstad.jcircsim.PhaseCompElm"));
        chipMenu.add(getClassCheckItem("Add Counter", "com.falstad.jcircsim.CounterElm"));
        chipMenu.add(getClassCheckItem("Add Decade Counter", "com.falstad.jcircsim.DecadeElm"));
        chipMenu.add(getClassCheckItem("Add 555 Timer", "com.falstad.jcircsim.TimerElm"));
        chipMenu.add(getClassCheckItem("Add DAC", "com.falstad.jcircsim.DACElm"));
        chipMenu.add(getClassCheckItem("Add ADC", "com.falstad.jcircsim.ADCElm"));
        chipMenu.add(getClassCheckItem("Add Latch", "com.falstad.jcircsim.LatchElm"));

        Menu otherMenu = new Menu("Other");
        mainMenu.add(otherMenu);
        otherMenu.add(getClassCheckItem("Add Text", "com.falstad.jcircsim.TextElm"));
        otherMenu.add(getClassCheckItem("Add Scope Probe", "com.falstad.jcircsim.ProbeElm"));
